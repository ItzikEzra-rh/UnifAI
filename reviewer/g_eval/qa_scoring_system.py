...
class GEvalQASystem:
    ...
    def _categorize_evaluation(self, evaluation: Dict[str, Any]) -> None:
        ...
        if evaluation["final_score"] >= self.config.SCORE_THRESHOLD:
            evaluation["element"]["review_failed"] = False
            self.passed_elements.append(evaluation["element"])
        else:
            evaluation["element"]["review_failed"] = True
            self.failed_elements.append(evaluation["element"])
            # TODO: In the future we can use the 'evaluation' object deeply review lower scores generated by the reviewer 

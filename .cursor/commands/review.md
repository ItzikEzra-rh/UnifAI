...
the review file should be build like this:
4. list of issues found split by areas and severity (area first)
5. at the top a short overview of the review and the purpose of the feature as you understood it
6. if a design is available add it to the file (if you created the design by running deep review add it as is if the design is part of the added files to the branch just specify its location)
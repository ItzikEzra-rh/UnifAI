...
from providers.backend import delete_session_from_chat_history, get_chat_history, get_test_content_from_gitlab, list_of_files_from_gitlab, insert_new_form, insert_new_prompt, get_forms, get_saved_prompts, \
                              insert_prompt_comment, insert_prompt_is_complete, insert_prompt_rating, rename_title_of_chat_session, update_current_chat_history
...
@backend_bp.route("/renameSession", methods=["POST"])
@from_body({
    "session_id":       fields.Str(required=True, data_key="sessionId"),

    ...
    <Card className="bg-background-card shadow-card border-gray-800 flex flex-col h-full max-h-[82.5vh]">
      ...
      <CardContent className="flex-1 overflow-hidden p-0 flex flex-col min-h-0">
        ...
        <div className="p-4 border-t border-gray-800 flex-shrink-0">
          ...
          {isSharingDisabled && blueprintExists && (
            <div className="mb-4 p-3 bg-orange-900/20 border border-orange-500/50 rounded-lg">
              <div className="flex items-center text-orange-200">
                <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                ...
                <span className="text-sm font-medium">
                  Workflow Unavailable: This workflow's chat sharing has been disabled and can no longer be continued.
                </span>
              </div>
            </div>
          )}
            ...
            <Textarea
              ...
              placeholder={
                !blueprintExists 
                  ...
                  : isSharingDisabled
                  ? "This chat cannot be continued - workflow sharing is disabled"
                  : "Ask a question about your data..."
              }
              className={`bg-background-dark min-h-[80px] resize-none ${(!blueprintExists || isSharingDisabled) ? 'opacity-50 cursor-not-allowed' : ''}`}
              rows={3}
              disabled={!blueprintExists || isSharingDisabled}
            />
            <Button
              onClick={handleSendMessage}
              disabled={inputMessage.trim() === "" || isTyping || !blueprintExists || isSharingDisabled}
